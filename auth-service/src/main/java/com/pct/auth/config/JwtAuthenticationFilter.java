...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest req, HttpServletResponse res, FilterChain chain) throws IOException, ServletException {
		...
		excludedUrls = Arrays.asList("springfox-swagger-ui", "swagger-resources", "swagger-ui.html", "/v2/api-docs", "/user/token/login", "/api/ping", "/api/resetRoleCache", "/#/login", "/azure/login", "/azure/logout", "/app/login", "/app/logout","/user/reset-password/admin");
