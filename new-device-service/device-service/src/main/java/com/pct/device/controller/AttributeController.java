...
public class AttributeController implements IApplicationController<Company> {
    ...
    public ResponseEntity<MessageDTO<String>> addAttribute(@RequestBody AttributeRequest attributeRequest) {
        ...
        return new ResponseEntity<MessageDTO<String>>(new MessageDTO<String>("Product attribute added successfully", "", true),
                HttpStatus.CREATED);
    }
