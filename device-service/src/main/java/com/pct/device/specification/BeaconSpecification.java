...
public final class BeaconSpecification {
	static Logger logger = LoggerFactory.getLogger(BeaconSpecification.class);
	
	public static Specification<Device> getBeaconListSpecification(String accountNumber, String uuid, DeviceStatus status,String mac,Map<String, String> attributeToValueMap,IOTType type) {
