...
//    AttributeValue findByAttributeUuidAndGatewayUuid(String attributeUuid, String relatedUuid);
    ...
    @Query("FROM AttributeValue attributeValue WHERE attributeValue.device.imei = :deviceId")
    List<AttributeValue> findByDeviceImei(@Param("deviceId") String deviceId);
    
    @Query("FROM AttributeValue attributeValue WHERE attributeValue.device.macAddress = :deviceId")
    List<AttributeValue> findByDeviceMacAddress(@Param("deviceId") String deviceId);
    
    @Query("FROM AttributeValue attributeValue WHERE attributeValue.device.imei = :deviceId and attributeValue.attribute.uuid = :attributeId")
    AttributeValue findByDeviceImeiAndAttribute(@Param("deviceId") String deviceId,@Param("attributeId") String attributeId);
