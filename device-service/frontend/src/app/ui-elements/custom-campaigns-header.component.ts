...
@Component({
  ...
  template: `
     <div style="cursor: pointer;">
      ...
      <div class="customHeaderLabel"   (click)="onSortRequestedName($event)">{{ params.displayName }}</div>&nbsp;
      <div
...
export class CustomCampaignsHeader {
  public params: any;
  ...
  onSortRequestedName(event) {
    if(this.params.displayName == 'Status'){
    return;
    }
    else if (this.params.column.sort == undefined) {
      this.sort = 'asc';
