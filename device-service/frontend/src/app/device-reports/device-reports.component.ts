...
export class DeviceReportComponent implements OnInit {
  ...
  constructor(public devicesListService: GatewayListService, public router: Router, private toastr: ToastrService, private pagerService: PagerService) {
    this.columnDefs =
     [
      {
  ...
  onGridReady(params: any) {
    ...
    var datasource = {
      getRows: (params: IGetRowsParams) => {
        ...
        var id = sessionStorage.getItem('device_id');
        ...
        this.devicesListService.getDeviceReportsElastic(this.gridApi.paginationGetCurrentPage() + 1, this.column, this.order, this.pageLimit, this.filterValuesJsonObj,id).subscribe(data => {
          this.loading = false;
